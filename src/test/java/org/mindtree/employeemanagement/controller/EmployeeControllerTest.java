...
//Boundary condition
	...
	//@Test
	public void verifyNoUserDetail() throws Exception {
		
		
		
		when(mockEmpService.getAllEmplyeeDetails()).thenReturn(null);
		mockmvc.perform(MockMvcRequestBuilders.delete("/empMgt/getAllEmpDetails").accept(MediaType.APPLICATION_JSON_VALUE))
		.andExpect(jsonPath("$.message").value("Record Not Found"))
		.andDo(print());
	}
